...
public interface VolumeMapper {
    ...
    @Insert("insert into jm_volume(id, name, scope, workflow_ref, worker_id, available, taint, cleaning, created_time, available_time) " +
    ...
    @Select("select * from jm_volume where name = #{name} and workflow_ref = #{workflowRef}")
    @Result(column = "workflow_ref", property = "workflowRef")
    @Result(column = "worker_id", property = "workerId")
    @Result(column = "created_time", property = "createdTime")
    @Result(column = "available_time", property = "availableTime")
    ...
    @Select("select * from jm_volume where workflow_ref = #{workflowRef}")
    @Result(column = "workflow_ref", property = "workflowRef")
    @Result(column = "worker_id", property = "workerId")
    @Result(column = "created_time", property = "createdTime")
    @Result(column = "available_time", property = "availableTime")
    ...
    @Select("select * from jm_volume where workflow_ref = #{workflowRef} and scope = #{scope}")
    @Result(column = "workflow_ref", property = "workflowRef")
    @Result(column = "worker_id", property = "workerId")
    @Result(column = "created_time", property = "createdTime")
    @Result(column = "available_time", property = "availableTime")
    ...
    @Update("update jm_volume set available = #{available}, cleaning = #{cleaning}, worker_id = #{workerId}, available_time = #{availableTime} where id = #{id}")
    void activate(Volume volume);

    @Update("update jm_volume set taint = #{taint} where id = #{id}")
    void taint(Volume volume);

    @Update("update jm_volume set cleaning = #{cleaning}, available = #{available} where id = #{id}")
    void clean(Volume volume);

    @Delete("delete from jm_volume where id = #{id}")
    void deleteById(String id);

    @Delete("delete from jm_volume where name = #{name} and workflow_ref = #{workflowRef}")
