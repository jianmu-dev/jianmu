...
public interface AsyncTaskInstanceMapper {
    @Select("select * from jm_async_task_instance where id = #{id}")
    ...
    @Select("select * from jm_async_task_instance where workflow_instance_id = #{instanceId}")
    @Result(column = "trigger_id", property = "triggerId")
    @Result(column = "workflow_ref", property = "workflowRef")
    @Result(column = "workflow_version", property = "workflowVersion")
    @Result(column = "workflow_instance_id", property = "workflowInstanceId")
    ...
    @Select("select * from jm_async_task_instance where trigger_id = #{triggerId}")
    @Result(column = "trigger_id", property = "triggerId")
    @Result(column = "workflow_ref", property = "workflowRef")
    @Result(column = "workflow_version", property = "workflowVersion")
    @Result(column = "workflow_instance_id", property = "workflowInstanceId")
    ...
    @Select("select * from jm_async_task_instance where trigger_id = #{triggerId} and async_task_ref = #{taskRef}")
    @Result(column = "trigger_id", property = "triggerId")
    @Result(column = "workflow_ref", property = "workflowRef")
    @Result(column = "workflow_version", property = "workflowVersion")
    @Result(column = "workflow_instance_id", property = "workflowInstanceId")
    ...
    @Insert("insert into jm_async_task_instance(id, trigger_id, workflow_ref, workflow_version, workflow_instance_id, name, description, status, failure_mode, async_task_ref, async_task_type, serial_no, next_target, activating_time, start_time, end_time) " +
    ...
    @Insert("<script>" +
            "insert into jm_async_task_instance(id, trigger_id, workflow_ref, workflow_version, workflow_instance_id, name, description, status, failure_mode, async_task_ref, async_task_type, serial_no, next_target, activating_time, start_time, end_time) values" +
    ...
    @Select("select _version from jm_async_task_instance where id = #{id}")
    int getVersion(String id);

    @Update("update jm_async_task_instance " +
    ...
    @Update("update jm_async_task_instance set status=#{status}, serial_no=#{serialNo}, next_target=#{nextTarget}, start_time=#{startTime}, end_time=#{endTime}, _version=#{version} where id=#{id}")
    void updateById(AsyncTaskInstance asyncTaskInstance);

    @Delete("delete from jm_async_task_instance where workflow_instance_id = #{workflowInstanceId}")
    void deleteByWorkflowInstanceId(String workflowInstanceId);

    @Delete("delete from jm_async_task_instance where workflow_ref = #{workflowRef}")
