...
public interface WorkflowMapper {
    ...
    @Select("<script>" +
            "select * from workflow WHERE `ref_version` IN " +
    ...
    @Insert("insert into workflow(ref_version, ref, version, type, tag, name, description, caches, nodes, global_parameters, dsl_text, created_time)" +
