<template>
  <div class="task-list" v-if="tasks.length > 1">
    <jm-dropdown placement="bottom-start" trigger="hover" max-height="186px" :append-to-body="false">
      <span>#{{ tasks.length - selectedIndex }}<i class="el-icon-arrow-down el-icon--right"></i></span>
      <template #dropdown>
        <jm-dropdown-menu>
          <jm-dropdown-item
            v-for="item in tasks"
